...
HD_PWD='D:/Documents/FAU/NanoSat/riscv_radhart_coll/RiscVFSM/RiscVTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_soc_boot_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv_soc_boot_top.tcl -notrace
