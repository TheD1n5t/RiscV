...
entity load_store_unit is
  port(
    ...
    store_be_o         : out std_logic_vector(3 downto 0);
...
begin
  process(rs2_i, store_size_i, byte_offset_i)
    ...
    case store_size_i is
      when "00" =>
        case byte_offset_i is
          when "00" =>
            tmp(7 downto 0)   := rs2_i(7 downto 0);
            be := "0001";
          when "01" =>
            tmp(15 downto 8)  := rs2_i(7 downto 0);
            be := "0010";
          when "10" =>
            tmp(23 downto 16) := rs2_i(7 downto 0);
            be := "0100";
          when others =>
            tmp(31 downto 24) := rs2_i(7 downto 0);
            be := "1000";
        end case;
