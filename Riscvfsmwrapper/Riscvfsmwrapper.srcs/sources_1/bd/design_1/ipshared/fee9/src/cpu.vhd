...
architecture rtl of riscv_core_memless is
  ...
  signal dmem_be_calc      : std_logic_vector(3 downto 0);
  ...
  signal cpu_dmem_be      : std_logic_vector(3 downto 0) := (others => '0');
...
begin
  ...
  --------------------------------------------------------------------
  cpu_dmem_we    <= '1' when state = ST_MEM_WRITE else '0';
  cpu_dmem_be    <= dmem_be_calc when state = ST_MEM_WRITE else (others => '0');
